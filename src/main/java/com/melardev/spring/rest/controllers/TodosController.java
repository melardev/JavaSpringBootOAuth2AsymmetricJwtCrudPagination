...
public class TodosController {
    ...
    public ResponseEntity<AppResponse> get(@PathVariable("id") Long id) {
        ...
        */
        return todo.<ResponseEntity<AppResponse>>map(t -> new ResponseEntity<>(new TodoDetailsResponse(t), HttpStatus.OK)).orElseGet(() -> new ResponseEntity<>(new ErrorResponse("Todo not found"), HttpStatus.NOT_FOUND));
    }
